// Detect Menu Button to active or disable left menu nav bar
...
function inactive_menu_btn() {
    ...
    inactive_bar.style.visibility = 'hidden';
    active_bar.style.visibility = 'visible';
...
function active_menu_btn() {
    inactive_bar.style.visibility = 'visible';
    active_bar.style.visibility = 'hidden';
